...
import first_question from "../../assets/math/fifth/first_question.png";
import second_question from "../../assets/math/fifth/second_question.png";
import third_question from "../../assets/math/fifth/third_question.png";
import fourth_question from "../../assets/math/fifth/fourth_question.png";
import fifth_question from "../../assets/math/fifth/fifth_question.png";
import "./FifthGrade.css";
...
const questions = [
  {
    id: 1,
    question: "Mi lesz a kivonás végeredménye?",
    image: first_question, 
    options: [
      { id: "a", text: " 530 865", isCorrect: true },
      { id: "b", text: "555 213", isCorrect: false },
      { id: "c", text: "600 283", isCorrect: false },
      { id: "d", text: "525 100", isCorrect: false }
    ]
  },
  {
    id: 2,
    question: "Mennyibe került Andi könyve?",
    image: second_question, 
    options: [
      { id: "a", text: "8500 Ft", isCorrect: false },
      { id: "b", text: "7 900 Ft", isCorrect: true },
      { id: "c", text: "5000 Ft", isCorrect: false },
      { id: "d", text: "5650 Ft", isCorrect: false }
    ]
  },
  {
    id: 3,
    question: "Mennyi pénze maradt Marcinak?",
    image: third_question, 
    options: [
      { id: "a", text: "1135 Ft", isCorrect: true },
      { id: "b", text: "1500 Ft", isCorrect: false },
      { id: "c", text: "1235 Ft", isCorrect: false },
      { id: "d", text: "1100 Ft", isCorrect: false }
    ]
  },
  {
    id: 4,
    ...
    options: [
      ...
      { id: "b", text: "2922", isCorrect: true },
      { id: "c", text: "3125", isCorrect: false },
      { id: "d", text: "2595", isCorrect: false }
    ]
  },
  {
    id: 5,
    question: "Menyni lesz a szorzás végeredménye?",
    image: fifth_question, 
    options: [
      { id: "a", text: "300 000", isCorrect: true },
      { id: "b", text: "3000", isCorrect: false },
      { id: "c", text: "300 000 000", isCorrect: false },
...
const FifthGrade = ({ username, onLogout }) => {
  const navigate = useNavigate();
            ...
            <div className="modal-dialog modal-dialog-centered">
              <div className="modal-content shadow-lg p-4 rounded-3 text-center">
                <div className="modal-body">
                  ...
                  <p className="fs-5 mb-4">Biztos el szeretnéd indítani az ötödik évfolyamosoknak szóló tesztet?</p>
