...
const questions = [
    {
      id: 1,
      question: "mennyivel több az 550 a 223-nál?",
      options: [
        { id: "a", text: "300", isCorrect: false },
        { id: "b", text: "327", isCorrect: true },
        { id: "c", text: "357", isCorrect: false },
        { id: "d", text: "387", isCorrect: false }
      ]
    },
    {
      id: 2,
      question: "mennyi (−550) és (−223) különbsége?",
      options: [
        { id: "a", text: "-457", isCorrect: false },
        { id: "b", text: "327", isCorrect: false },
        { id: "c", text: "-327", isCorrect: true },
        { id: "d", text: "-227", isCorrect: false }
      ]
    },
    {
      id: 3,
      question: "mennyiből kell (−7)-et elvenni, hogy + 7-et kapjunk?",
      options: [
    ...
    {
      id: 5,
      question: "Ha pozitív számból negatív számot vontunk ki, akkor negatív számot kaptunk.",
      options: [
        { id: "a", text: "Igaz", isCorrect: false },
        { id: "b", text: "Hamis", isCorrect: true }
      ]
    }
  ];
...
const SixthGrade = ({ username, onLogout }) => {
  const navigate = useNavigate();
            ...
            <div className="modal-dialog modal-dialog-centered">
              <div className="modal-content shadow-lg p-4 rounded-3 text-center">
                <div className="modal-body">
                  ...
                  <p className="fs-5 mb-4">Biztos el szeretnéd indítani a hatodik évfolyamosoknak szóló tesztet?</p>
