...
import first_question from "../../assets/math/second/first_question.png";
import second_question from "../../assets/math/second/second_question.png";
import third_question from "../../assets/math/second/third_question.png";
import fourth_question from "../../assets/math/second/fourth_question.png";
import fifth_question from "../../assets/math/second/fifth_question.png";
import "./SecondGrade.css";
...
const questions = [
  {
    id: 1,
    question: "Rendezzed a számokat növekvő sorrendbe!",
    image: first_question,
    options: [
      { id: "a", text: "16, 7, 21, 20, 19, 2, 18, 0", isCorrect: false },
      { id: "b", text: "0, 2, 7, 16, 18, 19, 20, 21", isCorrect: true },
      { id: "c", text: "21, 20, 19, 18, 16, 7, 2, 0", isCorrect: false },
    ]
  },
  {
    id: 2,
    question: "Mi lesz a helyes végeredmény?",
  ...
  {
    id: 4,
    question: "Melyik a megfelelő relációs jel a két szám között?",
  ...
  {
    id: 5,
    question: "Mennyit kell a 18-hoz adni, hogy 24 legyen a végeredmény?",
...
const SecondGrade = ({ username, onLogout }) => {
  const navigate = useNavigate();
  const [sidebarOpen, setSidebarOpen] = useState(false);
  const [showConfirmation, setShowConfirmation] = useState(true);
  const [currentQuestionIndex, setCurrentQuestionIndex] = useState(0);
  const [timeLeft, setTimeLeft] = useState(60); // 60 mp
            ...
            <div className="modal-dialog modal-dialog-centered">
              <div className="modal-content shadow-lg p-4 rounded-3 text-center">
                <div className="modal-body">
                  ...
                  <p className="fs-5 mb-4">Biztos el szeretnéd indítani a második évfolyamosoknak szóló tesztet?</p>
